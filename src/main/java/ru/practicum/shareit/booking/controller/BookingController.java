...
public class BookingController {
    ...
    @PostMapping
    public ReturnBookingDto createBooking(@RequestBody @Valid BookingDto dtoBooking, @RequestHeader("X-Sharer-User-Id") Integer userId) {
    ...
    public ReturnBookingDto approve(@PathVariable Integer bookingId,
    ...
    public ReturnBookingDto getBookingById(@PathVariable Integer bookingId,
                                  @RequestHeader("X-Sharer-User-Id") Integer userId) {
